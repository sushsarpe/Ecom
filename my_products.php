            ...
            <div class="container">
                ...
                <div class="col-md-9">
                  ...
                  if(!isset($_GET['p_cat'])){
                    ...
                    $get_product="select * from product where c_id='$c_id' order by 1 DESC LIMIT $start_from, $per_page";
                    ...
                    while ($row=mysqli_fetch_array($run_pro)){
                        ...
                        <div class='col-md-4 col-sm-6 center responsive'>
                         ...
                         <div class='text'>
                              ...
                              <p class='buttons'>
                                  <a href='details.php?pro_id=$pro_id' class='btn btn-default'>Edit Details</a>
                        ...
                        <ul class="pagination">
                            <?php
                                ...
                                $result=mysqli_query($con,$query);
                                 ...
                                 echo "
                                 <li>
                                     <a href='my_products.php?page=1'> ".'First Page'."</a>
                                 </li>";
                                 for($i=2; $i<=$total_pages;$i++){
                                     echo "
                                     <li> <a href='my_products.php'>".$i."</a></li>
                                     ";
                                 ...
                                 echo "
                                 <li>
                                    <a href='my_products.php'> ".'Last Page'."</a>  
                                 </li>";
