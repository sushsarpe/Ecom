...
multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="submit" name="submit" value="Insert User" class=" 
...
move_uploaded_file($temp_name,"admin_image/$admin_img");
$insert_admin = "insert into admins(admin_name,admin_email,admin_pass,admin_image,admin_contact,admin_country,admin_job,admin_about) values
('$admin_name','$admin_email','$admin_pass','$admin_img','$admin_contact', '$admin_country', '$admin_job', '$admin_about')";
