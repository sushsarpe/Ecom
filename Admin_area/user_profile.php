...
$get_admin = "select * from admins where admin_id=1";
...
<div class="col-md-6">
<input type="text" name="admin_name" class="form-control" required value="
<?php echo $admin_name; ?>" >
</div>
</div>
...
<div class="col-md-6">
<input type="text" name="admin_email" class="form-control" required value="
...
<div class="col-md-6">
<input type="text" name="admin_pass" class="form-control" required value="
<?php echo $admin_pass; ?>" >
</div>
</div>
...
<div class="col-md-6">
<input type="text" name="admin_job" class="form-control" required value="
<?php echo $admin_job; ?>" >
</div>
</div>
...
<div class="col-md-6">
<input type="text" name="admin_contact" class="form-control" required value="
...
<div class="col-md-6">
<textarea name="admin_about" class="form-control" rows="3"><?php echo 
$admin_about; ?></textarea>
</div>
</div>
...
if($run_admin){
    echo "<script>alert('User Has Been Updated Successfully. Login Again')</script>";
    echo "<script>window.open('login.php','_self')</script>";
    session_destroy();
}
}
